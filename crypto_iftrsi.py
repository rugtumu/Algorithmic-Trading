...
cryptos = ['BINANCE:BTCUSDT', 'BINANCE:ETHUSDT', 'BINANCE:LTCUSDT', 'BINANCE:SOLUSDT', 'BINANCE:BNBUSDT',
           ...
           'BINANCE:TRXUSDT', 'BINANCE:SHIBUSDT', 'BINANCE:LINKUSDT', 'BINANCE:BCHUSDT', 'BINANCE:UNIUSDT',
           'BINANCE:TAOUSDT', 'BINANCE:ETCUSDT', 'BINANCE:WIFUSDT', 'BINANCE:OPUSDT', 'BINANCE:FILUSDT',
           'BINANCE:INJUSDT', 'BINANCE:ATOMUSDT', 'BINANCE:SEIUSDT', 'BINANCE:RUNEUSDT']
