...
data = pd.read_csv('/home/umut/trade/data/Bitstamp_BTCUSDT_1h.csv')
...
data.to_csv('/home/umut/trade/data/modified_bitcoin_data_hourly.csv', index=False)

# Display
print("Data has been saved to 'modified_bitcoin_data_hourly.csv'.")